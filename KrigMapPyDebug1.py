...
def universal_printH(message: str):
    ...
    global UseNiceGUI #, home_container
    if UseNiceGUI:
        #with home_container:
        label = ui.label("")
...
def main(source_name : str):
    ...
    for src in range(0, len(source_name)):
        ...
        #if field == "variogramModel": universal_printH(f"     {variogram_models[int(input_par[field])]}")
...
if UseNiceGUI:
    ...
    source_name = [
        "2025-06-27-Seibersdorf_Medusa_dose.input.csv"
    ]
    main(source_name)
